resource "oci_core_security_list" "rdbseclist" {
  ...
  ingress_security_rules = [
    ...
    },
    {
      ...
      source = "10.11.28.0/24"
    },
    {
      protocol = "all"
      source   = "10.11.17.0/24"
    },
    {
      protocol = "all"
      source   = "10.11.18.0/24"
    },
    {
      protocol = "all"
      source   = "10.11.19.0/24"
    },
    {
      protocol = "6"
